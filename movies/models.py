...
class Actor(models.Model):
    ...
    description = models.TextField(verbose_name='Описание')
    image = models.ImageField(verbose_name='Изображение', upload_to='actor/')
...
class Movie(models.Model):
    ...
    year = models.PositiveIntegerField(verbose_name='Дата выхода', default=2019)
    ...
    budger = models.PositiveIntegerField(verbose_name='Бюджет', default=0, help_text='указывать сумму в долларах')
